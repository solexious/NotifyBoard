...
$(INSTALL_DIR)/libraries/Sprite/Sprite.cpp \
$(INSTALL_DIR)/libraries/Wire/Wire.cpp \
$(INSTALL_DIR)/libraries/Ethernet/Ethernet.cpp \
$(INSTALL_DIR)/libraries/Matrix/Matrix.cpp \
